---
title: 编程范式游记
date: 2019-07-20 13:47:40
keywords: 范式编程
description: 我从 C 语言开始说起，聊了聊面向过程式的编程范式，相信从代码的角度你对这类型的语言已经有了一些理解。作为一门高级语言，C 语言绝对是编程语言历史发展中的一个重要里程碑，但随着认知的升级，面向过程的 C 语言已经无法满足更高层次的编程的需要。于是，C++ 出现了。
categories: 
  - 范式编程
tags:
  - 编程模式
...
![img](https://static001.geekbang.org/resource/image/ee/4a/ee4024dab4a56d261b371bde8d786f4a.jpg)
